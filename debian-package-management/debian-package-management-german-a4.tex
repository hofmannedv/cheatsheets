...
\hypersetup{
    ...
    pdftitle={Cheatsheet für das Debian-Paketmanagement},
    pdfkeywords={Paketverwaltung, Debian GNU/Linux, dpkg, apt},
    pdfsubject={Kommandos für den effektiven Umgang mit der Paketverwaltung unter Debian GNU/Linux},
